...
class SblSecondaryList(
    ...
    override val acrobatics = SblSecondaryCharacteristic(parent = this)
    override val athletics = SblSecondaryCharacteristic(parent = this)
    override val climb = SblSecondaryCharacteristic(parent = this)
    override val jump = SblSecondaryCharacteristic(parent = this)
    override val ride = SblSecondaryCharacteristic(parent = this)
    override val swim = SblSecondaryCharacteristic(parent = this)

    override val intimidate = SblSecondaryCharacteristic(parent = this)
    override val leadership = SblSecondaryCharacteristic(parent = this)
    override val persuasion = SblSecondaryCharacteristic(parent = this)
    override val style = SblSecondaryCharacteristic(parent = this)

    override val notice = SblSecondaryCharacteristic(parent = this)
    override val search = SblSecondaryCharacteristic(parent = this)
    override val track = SblSecondaryCharacteristic(parent = this)

    override val animals = SblSecondaryCharacteristic(parent = this)
    override val appraise = SblSecondaryCharacteristic(parent = this)
    override val herbalLore = SblSecondaryCharacteristic(parent = this)
    override val history = SblSecondaryCharacteristic(parent = this)
    override val memorize = SblSecondaryCharacteristic(parent = this)
    override val magicAppraise = SblSecondaryCharacteristic(parent = this)
    override val medic = SblSecondaryCharacteristic(parent = this)
    override val navigate = SblSecondaryCharacteristic(parent = this)
    override val occult = SblSecondaryCharacteristic(parent = this)
    override val sciences = SblSecondaryCharacteristic(parent = this)

    override val composure = SblSecondaryCharacteristic(parent = this)
    override val strengthFeat = SblSecondaryCharacteristic(parent = this)
    override val resistPain = SblSecondaryCharacteristic(parent = this)

    override val disguise = SblSecondaryCharacteristic(parent = this)
    override val hide = SblSecondaryCharacteristic(parent = this)
    override val lockPick = SblSecondaryCharacteristic(parent = this)
    override val poisons = SblSecondaryCharacteristic(parent = this)
    override val theft = SblSecondaryCharacteristic(parent = this)
    override val stealth = SblSecondaryCharacteristic(parent = this)
    override val trapLore = SblSecondaryCharacteristic(parent = this)

    override val art = SblSecondaryCharacteristic(parent = this)
    override val dance = SblSecondaryCharacteristic(parent = this)
    override val forging = SblSecondaryCharacteristic(parent = this)
    override val music = SblSecondaryCharacteristic(parent = this)
    override val sleightHand = SblSecondaryCharacteristic(parent = this)
    ...
    override fun toggleNatBonus(characteristic: SecondaryCharacteristic) {
        ...
        //if natural bonus is currently on
            ...
            if(sblChar.getCharAtLevel().secondaryList.getAllSecondaries()[(characteristic as SblSecondaryCharacteristic).getIndex()].bonusApplied.value)
