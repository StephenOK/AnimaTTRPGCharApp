...
import com.example.animabuilder.ListenerImplementations.InputFilterMinMax
import com.example.animabuilder.ListenerImplementations.CharacteristicInput
    ...
    override fun onCreateView(
        ...
        levelSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(adapterView: AdapterView<*>?, view: View, i: Int, l: Long) {
                ...
                charInstance.lvl = levelSpinner.selectedItem.toString().toInt()
