...
class EarthBook: Serializable {
    ...
    val weightIncrement = Spell(
        "Weight Increment",
        Element.Earth,
        true,
        10,
        40,
        "It increases a physical body's weight by 20 kg.",
        "+10 kg",
        30,
        10,
        true,
    ...
    val shell = Spell(
        ...
        26,
        80,
        "This spell creates a physical shell with an AT 2 against all kinds of attack, " +
    ...
    val telemetry = Spell(
        ...
        "This spell allows the caster to read the story of an object or person he comes " +
                ...
                "involved during the past year. Individuals have the change of repelling the " +
    ...
    val petrify = Spell(
        ...
        "This spell transforms a physical being into a stone statue. The targeted " +
                ...
                "affected by a Petrify spell is entitled to a reroll after hte first day he has " +
    ...
    val reverseGravity = Spell(
        ...
        "+30 meters to radius and height",
        20,
        5,
        true,
        listOf(SpellType.Automatic)
    ...
    val gravityControl = Spell(
        "Gravity Control",
        Element.Earth,
        true,
        92,
        350,
        "This spell grants complete control of all gravity forces in a particular area of " +
