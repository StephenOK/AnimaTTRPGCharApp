...
class WaterBook: Serializable {
    val spring = Spell(
        ...
        2,
        30,
        "This spell draws forth any nearby underground current or stream, causing  spring " +
    ...
    val createChill = Spell(
        ...
        "This spell creates one ice or cold intensity. The temperature will remain stable " +
                "for as long as hte mage maintains the spell.",
    ...
    val crystallization = Spell(
        ...
        "This spell turns a body into crystal, rendering it fragile and brittle The " +
                ...
                "stop his whole body from freezing and being subject ot immediate Minor " +
    ...
    val iceStorm = Spell(
        ...
        "This spell creates a heavy ice storm that freezes anything in its path. Anyone " +
                ...
                "Turns or automatically suffer a 10-point cold-based damage, plus a cumulative " +
    ...
    val soulReflection = Spell(
        ...
        "This spell produces the spiritual reflection of a person or creature. The result " +
                ...
                "the caster himself. If a spellcaster uses Added Effects to increase the maximum " +
