...
class Energy {
    ...
    val allPowers = listOf(objectCreation, energyDischarge, createEnergy, energyShield, senseEnergy,
        modifyNature, undoEnergy, immunity, controlEnergy, energyDome, majorEnergy)
}