...
class FireBook: Serializable {
    ...
    private val controlFire = Spell(
        ...
        20,
        50,
        "This spell grants the caster control of fire with up to 5 levels of Intensity. He can " +
    ...
    private val consumeEssence = Spell(
        ...
        "This spell creates a terrifying supernatural aura around the spellcaster that can " +
                ...
                "Failure. Life Points lost through this spell cannot be recovered naturally; " +
                "healing magic is required restore their health. Spellcasters can only recover lost " +
    ...
    private val lordOfFire = Spell(
        ...
        96,
        300,
        "The caster controls all heat nuclei in a 100-kilometer radius. This dominion " +
    ...
    private val armageddon = Spell(
        ...
        "The definitive Fire spell allows the caster to consume a portion of the world\'s " +
                ...
                "is maintained.",
        "+3 kilometers to radius and +5 to MR Difficulty",
        30,
        5,
        true,
        listOf(SpellType.Automatic)
