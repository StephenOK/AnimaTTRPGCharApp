...
class CharClass(var heldClass: ClassName) : Serializable {
    ...
    /**
     * Initialize values for the class with the given array of numbers
     */
    ...
    /**
     * Constructor for character's class
     * Initializes growth values associated with that class
     */
    init {
        //get array to initialize class growth values
